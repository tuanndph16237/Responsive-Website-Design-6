...
<body class="home-page home-01 ">
                            ...
                            <ul>
                                ...
                                <li class="menu-item menu-item-has-children parent">
                                    ...
                                    <ul class="submenu curency">
                                        ...
                                        <li class="menu-item">
                                            <a title="Sale Setting" href="{{ route('admin.sale') }}">Manage Sale</a>
                                        </li>
                                        <li class="menu-item">
    ...
    {{-- <script src="https://cdn.tiny.cloud/1/4vsstl00j454g5gtx4bw0pt6c5au988mro86mwijrhpmyywq/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script> --}}
