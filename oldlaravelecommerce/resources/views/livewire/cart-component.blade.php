	...
	<main id="main" class="main-site">
	    ...
	    <div class="container">
	        ...
	        <div class=" main-content-area">
	            ...
	            <div class="summary">
	                <div class="order-summary">
	                    ...
	                    <p class="summary-info"><span className="title">Subtotal</span><b class="index">${{Cart::instance('cart')->subtotal()}}</b></p>
	        ...
	        <div class="wrap-iten-in-cart">
	            ...
	            <div class="alert alert-success">
	                <strong>Successful</strong> {{ Session::has('s_success_message') }}
	            </div>
	            @endif
