                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center list-action">
                                    @can('role_show')
                                    <a class="badge badge-info mr-2" data-toggle="tooltip" data-placement="top" title="Xem chi tiết" data-original-title="View" href="{{ route('roles.show',['role' => $item->id]) }}"><i class="fa fa-eye mr-0"></i></a>
                                    @endcan
                                    @can('role_edit')
                                    <a class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top" title="Cập nhật" data-original-title="Edit" href="{{ route('roles.edit',['role' => $item->id]) }}"><i class="fa fa-pen mr-0"></i></a>
                                    @endcan
                                    @can('role_delete')
