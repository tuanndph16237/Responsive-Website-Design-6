            ...
            <div class="owl-carousel owl-theme blog-slider">
                ...
                <div class="card blog__slide text-center">
                    <div class="blog__slide__img">
                        <img class="card-img rounded-0" src="{{ Storage::url($category->image) }}" alt="" />
                    </div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="single-recent-blog-post">
                        <div class="thumb">
                            ...
                            <ul class="thumb-info">
                                <li>
                                    <a href="{{ route('post.show',$post->slug) }}/#disqus_thread"></a>
                                </li>
                            </ul>
                        </div>
                        <div class="details mt-20">
                            ...
                            <a class="button" href="{{ route('post.show', $post) }}">Read More <i class="ti-arrow-right"></i></a>
                        </div>
                    </div>
                    @endforeach
                    <div class="row">
